// // src/generators/templates/ModernDesignedInvoiceTemplate.ts
...
// /**
//  * 3) ModernDesignedInvoiceTemplate:
//  * Supports providing both a **logo** and a **background design** (color band or rectangle).
//  */

// export class ModernDesignedInvoiceTemplate implements TemplateRenderer {
...
//     // Draw a background rectangle if backgroundColor is provided
