...
class MinimalTemplate extends TemplateRenderer_1.TemplateRenderer {
    getTemplateType() {
        return types_1.TemplateType.MINIMAL;
    }
    async renderContent() {
    ...
    renderMinimalParties() {
        ...
        if (invoice.seller.address) {
            ...
            y -= 18;
            if (a.street) {
                this.drawText(a.street, margins.left, y, { size: 9, color: '#333333' });
                y -= 12;
            }
            this.drawText(`${a.postalCode} ${a.city}`, margins.left, y, { size: 9, color: '#333333' });
            y -= 12;
        ...
        if (invoice.buyer.address) {
            ...
            y -= 18;
            if (a.street) {
                this.drawText(a.street, buyerX, y, { size: 9, color: '#333333' });
                y -= 12;
            }
            this.drawText(`${a.postalCode} ${a.city}`, buyerX, y, { size: 9, color: '#333333' });
            y -= 12;
    ...
    renderMinimalLineItems() {
        ...
        for (let i = 0; i < invoice.lines.length; i++) {
            ...
            this.drawText((0, core_1.formatAmount)(line.unitPrice) + ' €', x, colY, { size: 9, color: '#333333' });
            x += colWidths.unitPrice;
            this.drawText(`${(0, core_1.formatAmount)(line.vatRate * 100)}%`, x, colY, { size: 9, color: '#333333' });
            x += colWidths.vatRate;
            this.drawText((0, core_1.formatAmount)(line.lineTotal) + ' €', x, colY, { size: 9, bold: true, color: '#000000' });
            y -= rowHeight;
        }
    ...
    async renderPaymentAndTotals() {
        ...
        this.drawText((0, core_1.formatAmount)(summary.lineTotal) + ' €', rightX + 130, y, { size: 9, color: '#333333' });
        y -= 18;
        this.drawText(this.strings.taxTotal, rightX, y, { size: 9, color: '#333333' });
        this.drawText((0, core_1.formatAmount)(summary.taxTotal) + ' €', rightX + 130, y, { size: 9, color: '#333333' });
        y -= 10;
        ...
        this.drawText((0, core_1.formatAmount)(summary.grandTotal) + ' €', rightX + 130, y, { size: 14, bold: true, color: '#000000' });
    ...
    renderTaxBreakdown() {
        ...
        for (const taxSum of summary.taxSummaries) {
            ...
            this.drawText((0, core_1.formatAmount)(taxSum.taxable) + ' €', rightX + 50, y, { size: 9, color: '#333333' });
            this.drawText((0, core_1.formatAmount)(taxSum.taxAmount) + ' €', rightX + 130, y, { size: 9, bold: true, color: '#000000' });
            y -= 14;
        }
        this.renderContext.currentY = y - 10;
    }
