...
class MinimalTemplate extends TemplateRenderer_1.TemplateRenderer {
    ...
    renderMinimalParties() {
        ...
        this.drawLine(margins.left, startY - 4, margins.left + 50, startY - 4, { color: '#333333', width: 0.5 });
        let y = startY - 20;
        ...
        this.drawLine(buyerX, startY - 4, buyerX + 30, startY - 4, { color: '#333333', width: 0.5 });
        y = startY - 20;
    ...
    renderTaxBreakdown() {
        ...
        this.drawLine(margins.left, startY - 4, margins.left + 120, startY - 4, { color: '#333333', width: 0.5 });
        let y = startY - 20;
    ...
    renderPaymentInfo() {
        ...
        this.drawLine(margins.left, startY - 4, margins.left + 150, startY - 4, { color: '#333333', width: 0.5 });
        let y = startY - 20;
        if (invoice.payment) {
            ...
            if (invoice.payment.dueDate) {
                ...
                this.drawText(invoice.payment.dueDate.toLocaleDateString(), margins.left + 10, y - 10, { size: 9, bold: true, color: '#000000' });
                y -= 24;
            }
    ...
    renderMinimalFooter() {
        ...
        this.drawLine(margins.left, footerY + 5, width - margins.right, footerY + 5, { color: '#cccccc', width: 0.5 });
