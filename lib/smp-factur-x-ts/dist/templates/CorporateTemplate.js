...
class CorporateTemplate extends TemplateRenderer_1.TemplateRenderer {
    ...
    async renderCorporateHeader() {
        ...
        this.drawText(`${this.strings.invoiceNumber}:`, rightX, startY - 50, { size: 8, color: '#999999' });
        ...
        this.drawText(`${this.strings.invoiceDate}: ${dateStr}`, rightX, startY - 72, { size: 8, color: '#404040' });
    ...
    renderTaxBreakdown() {
        ...
        this.drawLine(margins.left, startY - 5, margins.left + 200, startY - 5, { color: '#b8a643', width: 1 });
        let y = startY - 22;
    ...
    renderPaymentInfo() {
        ...
        this.drawLine(margins.left, startY - 5, margins.left + 250, startY - 5, { color: '#b8a643', width: 1 });
        let y = startY - 25;
        if (invoice.payment) {
            ...
            if (invoice.payment.dueDate) {
                ...
                this.drawText(invoice.payment.dueDate.toLocaleDateString(), margins.left + 60, y, { size: 9, bold: true, color: '#b8a643' });
                y -= 16;
            }
