export { FacturxProfile, DocTypeCode, TaxCategoryCode, PaymentMeansCode, UnitCode, PostalAddress, TradeParty, PaymentDetails, DocumentHeader, InvoiceLine, AllowanceCharge, TaxSummary, MonetarySummary, ValidationResult, ProfilePolicy, } from './types';
...
export { XML_NAMESPACES, GUIDELINE_URNS, PROFILE_POLICIES, PATTERNS, getGuidelineUrn, getProfilePolicy, formatDateFacturX, formatAmount, } from './core/constants';
