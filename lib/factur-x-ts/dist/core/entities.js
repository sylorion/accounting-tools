...
class TradePartyImpl {
    constructor(name, address, tradingName, vatId, taxId, legalId, email, phone, globalId) {
        this.name = name;
...
class TradePartyBuilder {
    ...
    build() {
        ...
        return new TradePartyImpl(this._name, this._address, this._tradingName, this._vatId, this._taxId, this._legalId, this._email, this._phone, this._globalId);
    }
}
